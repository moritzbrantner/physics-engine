...
2. sampled rotational contact search over the canonical free-flight sampler;
3. rotational response and repeated-event stepping while preserving the explicit sampled-versus-analytic CCD boundary;
