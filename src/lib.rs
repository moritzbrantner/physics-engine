...
//! contact search, positive-progress clear/recontact search, shared sampled rotating-contact frontiers,
//! and deterministic OBB/frontier response. The current `World` solver remains translational and AABB-only.
//! Rendering, ECS storage, game loops and scene ownership belong to consumers.
...
pub use rotating_new_contact_search::sampled_new_rotating_contact_search;
