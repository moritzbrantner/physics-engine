...
//! free-flight sampling, deterministic rotational broad-phase pairing, and explicit sampled rotating
//! contact search. The current `World` solver remains translational and AABB-only. Rendering, ECS
//! storage, game loops and scene ownership belong to consumers.
