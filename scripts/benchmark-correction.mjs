...
async function replay(mode,upright,type,shot,measure=true){
 ...
 function step(phase,t){
  ...
  workHash.update(JSON.stringify(stats.filter((_,i)=>i!==23))); // experimental row storage changes payload, not physical work
